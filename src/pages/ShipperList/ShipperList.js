        ...
        <div className="header">
          <div className="row">
            <div className="col-lg-6 col-md-5 col-sm-4 col-xs-4">
              <h1 className="title-header">Danh sách Shipper</h1>
            </div>
                ...
                <table className="table table-bordered tb-money">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Số 9 lô 5B, Đường Trung Yên 6, Trung Yên, Trung Hòa, Cầu Giấy</td>
                      <td>14/02/2019 15:55</td>
                      <td><i class="color-blue fas fa-pen-square"></i></td>
                    </tr>
                    <tr>
                      <td>2</td>
                      <td className="color-blue">#HF005889</td>
